        ...
        <form onSubmit={isCreateAccount ? handleCreateAccount : handleLogin}>
          ...
          <div className="mb-4">
            ...
            <input
              ...
              className="w-full px-3 py-2 text-black font-serif font-medium border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
              required
            />
          </div>
          ...
          {isCreateAccount && (
            <div className="mb-4">
              ...
              <input
                ...
                onChange={handleChange}
                className="w-full px-3 py-2 border text-black font-serif font-medium  rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                required
              />
            </div>
          )}
