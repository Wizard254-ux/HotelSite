...
<li onClick={()=>goTo('/Admin')}><span  className="md:buttons hover:cursor-pointer block py-3 px-4 md:bg-yellow-400 hover:bg-gray-400 hover:text-black text-xl rounded-md transition-colors duration-300">      <i className="fas fa-envelope mr-2"></i> Admin
</span></li>
{isClientAuthorized&&
